...
export const buffer_copy_baseline: (a: number, b: number) => [number, number];
...
export const cosine_similarity_unrolled_scalar: (a: number, b: number, c: number, d: number) => number;
...
export const dot_product_unrolled_scalar: (a: number, b: number, c: number, d: number) => number;
...
export const lz4_compress_experimental: (a: number, b: number) => [number, number];
...
export const quantize_int8_unrolled_scalar: (a: number, b: number, c: number) => [number, number];
export const relu: (a: number, b: number) => [number, number];
export const sigmoid: (a: number, b: number) => [number, number];
export const simd128_enabled: () => number;
...
export const vector_norm_unrolled_scalar: (a: number, b: number) => number;
...
export const cosine_similarity_simd128: (a: number, b: number, c: number, d: number) => number;
export const dequantize_int8_simd128: (a: number, b: number, c: number) => [number, number];
export const dot_product_simd128: (a: number, b: number, c: number, d: number) => number;
export const quantize_int8_simd128: (a: number, b: number, c: number) => [number, number];
export const vector_add_simd128: (a: number, b: number, c: number, d: number) => [number, number];
export const vector_elementwise_multiply_simd128: (a: number, b: number, c: number, d: number) => [number, number];
export const vector_norm_simd128: (a: number, b: number) => number;
